...
public class Spu implements Serializable {
	...
	private String introduction_c;//电脑详情
	private String introduction_m;//手机详情

	public String getIntroduction_c() {
		return introduction_c;
	}

	public void setIntroduction_c(String introduction_c) {
		this.introduction_c = introduction_c;
	}

	public String getIntroduction_m() {
		return introduction_m;
	}

	public void setIntroduction_m(String introduction_m) {
		this.introduction_m = introduction_m;
	}
